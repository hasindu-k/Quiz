...
class MainActivity : AppCompatActivity() {
    ...
    private fun generateRandomQuestion(): Question {
        ...
        val operation = random.nextInt(2) // 0 for addition, 1 for subtraction
    ...
    private fun generateOptions(correctAnswer: Int): List<String> {
        ...
        while (options.size < 4) {
            ...
            if (wrongAnswer > 0 && wrongAnswer != correctAnswer && !options.contains(wrongAnswer.toString())) {
...
//        startButton.setText("    Play Again     ")
    ...
    private fun updateHighScore(): Boolean {
